...
- **Content**: Comprehensive system documentation including:
  ...
  - Testing and quality assurance (253 tests)
...
This creates 7 test users (user1-5, admin, anonymous) with known passwords. Run this before integration tests or when you need a clean database state.

#### Quick Test Commands

**Run all tests** (253 tests, ~2-5 seconds):
```bash
python -m pytest -v
```
...
| **Mypy Type Errors** | 0 | ✅ Type-safe (139 suppressed) |
...
|------|----------|---------|
| Feb 6, 2026 | docs/README.md | Updated test count to 253; added database reset script documentation; added mypy status |
| Feb 6, 2026 | All | Fixed database.html ThemeManager errors; improved docs-viewer.html styling |
...
**Document Index Version**: 2.1  
**Documentation Status**: ✅ Complete and Current  
**Last Audit**: February 6, 2026  
**Test Coverage**: 67% (253 tests passing, 0 mypy errors)  
